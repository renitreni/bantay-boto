                ...
                <div class="card-body p-4">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="button" wire:click="submit" class="btn btn-success">Save</button>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#destroyModal">Delete
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        This Blog Post will be deleted permanently.
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" wire:model="destroy" class="btn btn-primary text-white">I Confirm</button>
                    </div>
                </div>
            </div>
        </div>
